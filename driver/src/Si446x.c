...
//    U8  cmd[10];
    ...
    SI446X_SET_PROPERTY_1(MODEM_DATA_RATE_1, (U8)((SI446X_MODEM_DATA_RATE * 40) >> 8), cs);
    SI446X_SET_PROPERTY_1(MODEM_DATA_RATE_0,(U8)(SI446X_MODEM_DATA_RATE * 40), cs);
    ...
    SI446X_SET_PROPERTY_1(MODEM_TX_NCO_MODE_2,(U8)(SI446X_FREQ_XO >> 16), cs);
    SI446X_SET_PROPERTY_1(MODEM_TX_NCO_MODE_1,(U8)( SI446X_FREQ_XO >> 8), cs);
    SI446X_SET_PROPERTY_1(MODEM_TX_NCO_MODE_0,(U8)( SI446X_FREQ_XO), cs);
