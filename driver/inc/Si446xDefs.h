...
typedef enum
{
    ...
    MODEM_DECIMATION_CFG2   = 0x2020,
    MODEM_IFPKD_THRESHOLDS  = 0x2021,
    ...
    MODEM_SPIKE_DET         = 0x2054,
    MODEM_ONE_SHOT_AFC      = 0x2055,
    MODEM_RSSI_MUTE         = 0x2057,
    MODEM_DSA_CTRL1         = 0x205B,
    MODEM_DSA_CTRL2         = 0x205C,
    MODEM_DSA_QUAL          = 0x205D,
    MODEM_DSA_RSSI          = 0x205E,
    MODEM_DSA_MISC          = 0x205F,
