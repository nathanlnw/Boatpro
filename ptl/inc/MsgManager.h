...
extern void MSGMAN_MsgRxProcess(void) ;
extern void MSGMAN_MsgTxProcess(void) ;
extern U8 SendMsg18Test(AisChannelEnum channel, S16 txSlot);
extern U8 MSGMAN_RxMsgListGetElem(MsgCellStruct *pMsgCellStruct);
